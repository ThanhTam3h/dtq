                                ...
                                <div class="auth__form-container">
                                    ...
                                    <div class="row">
                                        <div class="auth__form-group col c-6">
                                            ...
                                            <input type="text" name="street" class="auth__form-input" placeholder="Nhập số nhà và tên đường">
                                        </div>
                                        <div class="auth__form-group col c-6">
                                            <div class="auth__form-group-title">
                                                <span>Thành phố</span>
                                            ...
                                            <select name="city" id="city" class="auth__form-input">
                                                ...
                                                <!-- Danh sách các thành phố từ JSON -->
                                            </select>
                                        </div>
                                        <div class="auth__form-group col c-6">
                                            <div class="auth__form-group-title">
                                            ...
                                            <select name="district" id="district" class="auth__form-input">
                                                ...
                                                <!-- Danh sách các quận sẽ được load bằng JavaScript -->
                                            </select>
                                        </div>
                                        <div class="auth__form-group col c-6">
                                            <div class="auth__form-group-title">
