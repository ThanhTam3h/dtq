...
<body>
    <div class="content">
        ...
        <div class="grid wide" style="border-top: 1px solid #ccc; padding-top: 4rem">
                                    ...
                                    <table id="choXN" class="choXN table_0">
                                        ...
                                        <table class="display display_0">
                                            ...
                                            <tbody>
                                                ...
                                                $result_infor_user = $infor_user->fetch_assoc();
                                                $address = $result_infor_user['street'];
                                                if ($getOrderHistory0) {
                                                    $i = 0;
                                                    $total0 = 0;
                                                    $orderID = "";
                                                    ...
                                                    while ($result_OrderHistory0 = $getOrderHistory0->fetch_assoc()) {
                                                        ...
                                                        $address = $result_OrderHistory0['street'];
                                                ?>
                                                        <tr>
                                                            <td><?= ($i = $i + 1); ?></td>
                                                            <td>
