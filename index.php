...
<body>
	<section class="app">
		...
		<div class="app_body">
							...
							<div class="fnc-slide__inner">
								...
								<div class="fnc-slide__content">
									...
									<button type="button" class="fnc-slide__action-btn">
										Mua ngay
										<span data-text="Mua ngay">Mua ngay</span>
									</button>
								</div>
							</div>
						</div>
											...
											<a href="chitietsanpham.php?productId=<?php echo $result['productId'] ?>&&brandId=<?php echo $result['brandId'] ?>&&type=<?php echo $result['type'] ?>">
												<div class="home-product-item">
													<div class="ovelay-img">
														...
														<div class="overlay">
															<!--buy-btn------>
															<a href="chitietsanpham.php?productId=<?php echo $result['productId'] ?>&&brandId=<?php echo $result['brandId'] ?>&&type=<?php echo $result['type'] ?>" class="buy-btn">Mua ngay</a>
														</div>
													</div>
				...
				<div class="grid wide">
					<div class="ds-layout">
						<h2 class="section-font">
							<span class="small-up-caps">Người mẫu</span>
			...
			<div class="grid wide">
				<h2 class="app_view-shop_tile">TIN TỨC</h2>
							...
							<div class="wrapper">
								<div class="header">
									<div class="date">
										...
										<span class="month">Tháng năm</span>
								...
								<div class="data">
									<div class="content">
										...
										<h1 class="title" style="color: black;"><a href="#">Những điều xa lạ: Âm thanh của Thế giới Đảo Lộn</a></h1>
										<p class="text" style="color: black;">Người hâm mộ không thể chờ đợi được sự ra mắt kỹ thuật số của bản nhạc phim Survive trên Netflix, ra mắt hôm nay.</p>
									</div>
								</div>
							</div>
						</div>
